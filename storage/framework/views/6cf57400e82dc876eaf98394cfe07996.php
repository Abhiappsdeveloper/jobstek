...
<body>
    <div class="login-main">
        ...
        <div class="login-block">
            <div class="colr">
                <img src="<?php echo e(asset('logo-light.svg')); ?>" alt="logo">
                <h1>CLIENT LOGIN</h1>
            </div>
            <form id="loginForm" method="POST" action="<?php echo e(route('login.submit')); ?>" autocomplete="off">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\jobstek\resources\views/auth/login.blade.php ENDPATH**/ ?>